...
function CreateStdAccessibleProxyA(hwnd: THandle; pClassName: PAnsiChar; idObject: Cardinal; const riid: TGUID; out ppvObject): HRESULT; stdcall;
...
// *********************************************************************//
  ...
  {$IFDEF CODEFACTOR_BUG_WORKAROUND}
  {$ELSE}
...
// *********************************************************************//
  ...
  {$ENDIF CODEFACTOR_BUG_WORKAROUND}
...
var
  AccPtr: Pointer;
begin
  CreateStdAccessibleProxyA(Handle, PAnsiChar(Classname), OBJID_CLIENT, IID_IAccessible, AccPtr);  { do not localize }
